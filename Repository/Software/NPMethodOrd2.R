...
bdg1.instr="For this choice task you choose between a gain right now (after 0 weeks) and a gain in 5 weeks.\n\nPress <Start Task> to continue."
bdg2.instr="For this next choice task you choose between a gain after 5 weeks and a gain in 10 weeks.\n\nPress <Start Task> to continue."
bdg3.instr="Now, you  choose between a gain right now (in 0 weeks) and a gain in 10 weeks.\n\nPress <Start Task> to continue."
bdl1.instr="You are  faced with decisions about gains at different points of time. You are  faced with decisions about losses at different points of time. For this choice task you choose between a loss right now (after 0 weeks) and a loss in 5 weeks.\n\nPress <Start Task> to continue."
bdl2.instr="For this next choice task you choose between a loss after 5 weeks and a loss in 10 weeks.\n\nPress <Start Task> to continue."
bdl3.instr="Now, you  choose between a loss right now (in 0 weeks) and a loss in 10 weeks.\n\nPress <Start Task> to continue."
...
callModule(PieBisection,"two",yT1=yT2,r1a=0,r1b=999,p1=0,r2a=yT1$l,r2b=0,p2=50,ssc=0,ssn=ssn,pbw=0,nbis=nbis,sg=sg,nextb=nextb2,bound=0,buttonID="two") #CE-Losses
callModule(PieBisection,"three",yT1=yT3,y,r1a=0,r1b=999,p1=0,r2a=G,r2b=0,p2=50,ssc=0,ssn=ssn,pbw=0,nbis=nbis,sg=sg,nextb=nextb3,bound=0,buttonID="three") #CE-Gains
callModule(PieBisection,"four",yT1=yT4,r1a=yT2$l,r1b=999,p1=50,r2a=sg,r2b=0,p2=50,ssc=0,ssn=ssn,pbw=0,nbis=nbis,sg=sg,nextb=nextb4,bound=1,buttonID="four") #offset gain
callModule(PieBisection,"five",yT1=yT5,r1a=yT4$l,r1b=999,p1=50,r2a=sg,r2b=yT2$l,p2=50,ssc=1,ssn=ssn,pbw=0,nbis=nbis,sg=sg,nextb=nextb5,bound=1,buttonID="five") #SS losses
callModule(PieBisection,"six",yT1=yT6,r1a=yT3$l,r1b=999,p1=50,r2a=sl,r2b=0,p2=50,ssc=0,ssn=ssn,pbw=0,nbis=nbis,sg=sg,nextb=nextb6,bound=1,buttonID="six") #offset loss
callModule(PieBisection,"seven",yT1=yT7,r1a=yT6$l,r1b=999,p1=50,r2a=sl,r2b=yT3$l,p2=50,ssc=1,ssn=ssn,pbw=0,nbis=nbis,sg=sg,nextb=nextb7,bound=1,buttonID="seven") #SS gains
callModule(PieBisection,"eight",yT1=yT8,r1a=0,r1b=999,p1=0,r2b=min(yT5$ss),r2a=0,p2=50,ssc=0,ssn=ssn,pbw=1,nbis=nbis,sg=sg,nextb=nextb8,bound=0,buttonID="eight") #PBW - losses
callModule(PieBisection,"nine",yT1=yT9,r1a=0,r1b=999,p1=0,r2a=max(yT7$ss),r2b=0,p2=50,ssc=0,ssn=ssn,pbw=1,nbis=nbis,sg=sg,nextb=nextb9,bound=0,buttonID="nine") #PBW - gains
callModule(TimeBisection,"ten",yT1=yT10,t1=0,r1=0.5*min(yT5$ss),t2=5,r2=0.5*min(yT5$ss),nbis=nbis,nextb=nextb10,bound=1,buttonID="ten") #Betadelta - L1
callModule(TimeBisection,"eleven",yT1=yT11,t1=5,r1=0.5*min(yT5$ss),t2=10,r2=0.5*min(yT5$ss),nextb=nextb11,nbis=nbis,bound=1,buttonID="eleven") #Betadelta - L2
callModule(TimeBisection,"twelve",yT1=yT12,t1=0,r1=0.5*max(yT7$ss),t2=5,r2=0.5*max(yT7$ss),nextb=nextb12,nbis=nbis,bound=1,buttonID="twelve") #Betadelta - G1
callModule(TimeBisection,"thirteen",yT1=yT13,t1=5,r1=0.5*max(yT7$ss),t2=10,r2=0.5*max(yT7$ss),nextb=nextb13,nbis=nbis,bound=1,buttonID="thirteen") #Betadelta - G2
...
observeEvent(nextb1$nextb,{
  insertTab('main',tab=PieBisectionUI("two",cel.instr,'Part2'),target='Part1',position='after')
  removeTab('main','Part1')
})

observeEvent(nextb2$nextb,{
  insertTab('main',tab=PieBisectionUI("three",ceg.instr,'Part3'),target='Part2',position='after')
  removeTab('main','Part2')
})

observeEvent(nextb3$nextb,{
  insertTab('main',tab=PieBisectionUI("four",ofg.instr,'Part4'),target='Part3',position='after')
  removeTab('main','Part3')
})

observeEvent(nextb4$nextb,{
  insertTab('main',tab=PieBisectionUI("five",ssl.instr,'Part5'),target='Part4',position='after')
  removeTab('main','Part4')
})

observeEvent(nextb5$nextb,{
  insertTab('main',tab=PieBisectionUI("six",ofl.instr,'Part6'),target='Part5',position='after')
  removeTab('main','Part5')
})

observeEvent(nextb6$nextb,{
  insertTab('main',tab=PieBisectionUI("seven",ssg.instr,'Part7'),target='Part6',position='after')
  removeTab('main','Part6')
})

observeEvent(nextb7$nextb,{
  insertTab('main',tab=PieBisectionUI("eight",pbwl.instr,'Part8'),target='Part7',position='after')
  removeTab('main','Part7')
})

observeEvent(nextb8$nextb,{
  insertTab('main',tab=PieBisectionUI("nine",pbwg.instr,'Part9'),target='Part8',position='after')
  removeTab('main','Part8')
})

observeEvent(nextb9$nextb,{
  insertTab('main',tab=TimeBisectionUI("ten",bdl1.instr,'Part10'),target='Part9',position='after')
  removeTab('main','Part9')
})

observeEvent(nextb10$nextb,{
  insertTab('main',tab=TimeBisectionUI("eleven",bdl2.instr,'Part11'),target='Part10',position='after')
  removeTab('main','Part10')
})

observeEvent(nextb11$nextb,{
  insertTab('main',tab=TimeBisectionUI("twelve",bdg1.instr,'Part12'),target='Part11',position='after')
  removeTab('main','Part11')
})


observeEvent(nextb12$nextb,{
  insertTab('main',tab=TimeBisectionUI("thirteen",bdg2.instr,'Part13'),target='Part12',position='after')
...
######################################################
  ...
  r1<-reactiveValues(ssl=c(),ssg=c(),pbg=c(0,0,0,0,0),pbl=c(0,0,0,0,0),dwl=c(0,0,0,0,0),dwg=c(0,0,0,0,0),ucg=c(),ucl=c(),lambda=2,alphag=0,alphal=0,aucg=0,aucl=0,gammag=0,gammal=0,r=0,b1=0,b2=0,bdg=c(),bdl=c())
  #utility
  r1$ssl<-c(yT2$ss,yT5$ss)
  r1$ssg<-c(yT3$ss,yT7$ss)
  r1$ucl<-c(0,(1:length(r1$ssl)/length(r1$ssl)))*-1
  r1$ucg<-c(0,(1:length(r1$ssg)/length(r1$ssg)))
  #Beta-delta
  r1$bdg<-c(yT12$l,yT13$l)
  r1$bdl<-c(yT10$l,yT11$l)
  #Reorder decision weights - losses
  ol=order(yT8$pbword)
  for(i in 1:5){r1$pbl[i]=yT8$ss[ol[i]]}
    #Reorder decision weights - gains
  og=order(yT9$pbword)
  for(i in 1:5){r1$pbg[i]=yT9$ss[og[i]]}
